 ...
 */
@Service
public class FrequentlyOrderJobServiceImpl implements FrequentlyOrderJobService {
    private final static Logger logger = LoggerFactory.getLogger(FrequentlyOrderJobServiceImpl.class);

    @Autowired
    private FrequentlyOrderService frequentlyOrderService;
    @Autowired
    ...
    private RiskSensitiveRecordDTO buildRiskSensitiveRecord(FrequentlyOrderDTO frequentlyOrder,
        ...
        sensitiveRecord.setSensitiveType(RiskSensitiveTypeEnum.FREQUENTLY_ORDER);
